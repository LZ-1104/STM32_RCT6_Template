...
/** @defgroup HSE_configuration 外部高速时钟配置
  * @{
  */
...
/** @defgroup PLL_entry_clock_source 锁相环输入时钟源
  * @{
  */
...
/** @defgroup PLL_multiplication_factor 倍频系数（2-16）
  * @{
  */
#ifndef STM32F10X_CL
...
/** @defgroup PREDIV1_division_factor 分频系数
  * @{
  */
#if defined (STM32F10X_LD_VL) || defined (STM32F10X_MD_VL) || defined (STM32F10X_HD_VL) || defined (STM32F10X_CL)
...
/** @defgroup AHB_clock_source AHB总线时钟源（在RCC的基础上多少分频）
  * @{
  */
...
/** @defgroup APB1_APB2_clock_source APB1总线时钟源
  * @{
  */
...
/** @defgroup RCC_Interrupt_source RCC中断时钟源
  * @{
  */
